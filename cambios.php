        ...
        <form method="POST" action="cambios.php" enctype="multipart/form-data">
            <div class="mb-3">
                <label for="id" class="form-label">
                    <p id="labform">Id de la receta</p>
                </label>
            ...
            <div class="mb-3">
                <label for="Descripcion" class="form-label">
                    <p id="labform">Descripcion</p>
                </label>
                <textarea class="form-control" id="Descripcion_input" rows="3" name="descripcion"><?php if (isset($descripcion)) {
                                                                                                        echo $descripcion; ?> <?php } ?></textarea>
            </div>

            <form>
                <div class="mb-3">
                    <label for="Ingredientes" class="form-label">
                        <p id="labform">Ingredientes</p>
                    </label>
                ...
                <div class="mb-3">
                    <label for="Proceso" class="form-label">
                        <p id="labform">Proceso</p>
                    </label>
                    <textarea class="form-control" id="Proceso_input" rows="6" name="proceso"><?php if (isset($proceso)) {
                                                                                                    echo $proceso; ?> <?php } ?></textarea>
                </div>

                <div class="mb-3">
                    <label for="foto" class="form-label">
                        <p id="labform">Imagen de la receta</p>
                    </label>
                    <div class="imgreceta"><img <?php if (isset($foto)) {
                                                    $tipo = $_FILES['receta']['type']; ?> src="data:image/<?php $tipo; ?>;base64,<?php echo base64_encode($foto); ?>" <?php } ?>></div>
                    <label for="cambiarfoto" class="form-label">
                        <p id="labform">Seleccionar una foto nueva...</p>
                    </label>
